...
namespace AnonymousWebApi.Data.Contracts.ContratModels
{
    public class CountryCommandText : ICountryCommandText
    {
        ...
        public string AddCountry => "Insert Into  MasterCountry ([CreatedUser],[CreatedDate],[UpdatedUser],[UpdatedDate],[Name],[CountryCode]) Values (@CreatedUser, @CreatedDate, @UpdatedUser, @UpdatedDate, @Name,@CountryCode)";
